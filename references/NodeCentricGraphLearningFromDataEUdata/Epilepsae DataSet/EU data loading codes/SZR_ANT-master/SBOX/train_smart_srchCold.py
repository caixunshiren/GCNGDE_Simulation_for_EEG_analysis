...
# TODO read these parameters from json
max_n_srch=10
C_ini=10
div_fac=5
patience=3
...
train_sens=np.zeros((n_train_subs,max_n_srch))
train_spec=np.zeros((n_train_subs,max_n_srch))
train_bal_acc=np.zeros((n_train_subs,max_n_srch))
valid_sens=np.zeros((n_train_subs,max_n_srch))
valid_spec=np.zeros((n_train_subs,max_n_srch))
valid_bal_acc=np.zeros((n_train_subs,max_n_srch))
