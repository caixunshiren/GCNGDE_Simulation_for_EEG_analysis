function plot_yhat_with_sgrams(sub,model_name,szr_num,chan)
% function plot_yhat_with_sgrams(sub,model_name,szr_num,chan)
%
% Inputs:
%  sub: subject id
%  model_name: classifier name
%  szr_num: the number of the clinical szr you want to plot (in order of
%           occurrence)
%  chan: the bipolar channel pair you want to plot
%
% Example:
%   plot_yhat_with_sgrams(565,'svmAesFinale_1',6,'HL4-HL5');
% 
