...
if sys.platform=='linux':
    yhat_path = os.path.join('/home/dgroppe/EU_YHAT_ORIG/',str(sub)+'_'+model_name)
    label_path =os.path.join('/home/dgroppe/EU_Y/',str(sub)+'_all_labels')
else:
    yhat_path = os.path.join('/Users/davidgroppe/ONGOING/EU_YHAT_ORIG/',str(sub)+'_'+model_name)
